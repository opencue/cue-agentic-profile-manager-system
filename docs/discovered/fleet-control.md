...
> 5 community-built skills curated by [cue](https://github.com/opencue/claude-code-skills) for the **fleet-control** profile.
...
**★ 3958** · exceptional (score 14.5) · TypeScript · tags: ade, claude-code, cli, codex, cursor-agent
