...
layout: page
updated: 2026-05-25
tags: [claude-code, skill, fleet-control, cybersecurity]
---

# ✨ [raydenai/queen-protocol](https://github.com/raydenai/queen-protocol)

**★ 0** · strong (score 5) · Shell · agent-protocol, anthropic, claude-code, claude-mesh, codex
...
[fleet-control](../fleet-control.md), [cybersecurity](../cybersecurity.md)
